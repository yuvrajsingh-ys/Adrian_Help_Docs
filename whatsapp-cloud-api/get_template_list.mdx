...
```
https://api.v7. AIP.com/whatsapp-automation/wa/templates?apiKey=*API KEY*
```
...
```
curl --location --request GET 'https://api.v7. AIP.com/whatsapp-automation/wa/templates?apiKey=*API KEY*' \\
