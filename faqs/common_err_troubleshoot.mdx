...
<AccordionGroup>
  ...
  <Accordion title="I'm unable to add more than three team members">
    There is a limit of 3 team members on the standard plan. If you need to add more, contact us at [support@AIP.com](mailto:support@AIP.com) to discuss options.
  </Accordion>
  ...
  <Accordion title="My payment link has expired">
    ...
    2. If money was deducted but the transaction failed, it typically returns within three business days. If not, contact us at [support@AIP.com](mailto:support@AIP.com).
  </Accordion>
