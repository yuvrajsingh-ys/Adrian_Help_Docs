---
title: "Integrate  AIP with Twilio"
description: "This page provides a step-by-step guide on integration of  AIP with Twilio"
---

### **Why use Twilio?**

Integrate Twilio with your  AIP chatbot to enable seamless SMS and WhatsApp messaging. This allows your chatbot to reach users directly on their phones, improving engagement, outreach, and customer satisfaction. Whether you're sending order updates or automating lead follow-ups, Twilio ensures reliable delivery.
...
- Your  AIP chatbot is published and assigned to a valid channel.

---

### **Steps to Integrate  AIP with Twilio:**

#### **Step 1: Going to Integration on  AIP**

1. Sign into your  AIP account and choose the chatbot. Go to "Third Party Apps Integrations"
...
#### **Step 2: Getting the Information from Twilio.**
 ...
 5. Copy and paste the same tokens in the  AIP Applciation.
 ...
 7. Fill the Name and Request URL which is under "Voice Configuration".
    - Set the name as " AIP".
    - Copy the code in  AIP Twilio Integration Screen, and paste it in the Request URL box.
 8. This will create a new application.
 9. Click on the application to see the **TwiLM App SID**. Copy the ID over to the  AIP platform.
...
14. Copy the same in your  AIP Account.
...
17. Make sure both the "Voice Configuration", and scrolling down, the Messaging Configuration have the URL as copied from  AIP.
...
<AccordionGroup>
  <Accordion title="Does  AIP offer SMS services with Twilio">
    No,  AIP only offers Twilio with Voice calling configuration.
  </Accordion>
