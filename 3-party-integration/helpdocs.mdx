...
- **Real-Time Knowledge Updates:** Ensure the chatbot delivers up-to-date information by syncing  AIP with the latest HelpDocs content.

---

### **Integrate  AIP with Helpdocs:-**

### **Step 1 of 5: Login to  AIP Account and Select Application to Integrate**

1. Login to your  AIP account, and select the Bot you want to integrate with HelpDocs.
...
8. Moreover, copy your API Key from here to paste it into your  AIP Account.
...
1. Now, as the connection of the  AIP and **HelpDocs** is established, you need to map the **parameters (fields) of HelpDocs **to the user response of the  AIP question.
...
Once you have established a connection between ** AIP** and **HelpDocs** and complete the mapping, you are ready to go for your first test lead. You can test your integration setup by creating a dummy lead on the bot. This lead should appear in your  AIP dashboard and in the HelpDocs you have integrated.
...
- Wrong Mapping Set up - Your mapping with  AIP Question and HelpDocs parameter is either incorrect or you haven’t added any mandatory parameter.
