...
### **How to use  AIP as Trigger**
 ...
 8. \
    You can now click on the "\+" icon in canvas and search for  AIP in the search bar.
...
### **How to use Action in  AIP**
 ...
 8. \
    Set up connection by providing the **API key and BotID **from  AIP as explained above.
