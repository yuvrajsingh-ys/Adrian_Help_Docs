...
2. \
   As a result, this mapping will enable the integration to **send the user's response from  AIP to GoHighLevel's CRM fields**, storing it correctly in the contact records.
