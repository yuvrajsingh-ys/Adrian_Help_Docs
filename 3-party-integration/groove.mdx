...
4. Copy the API token under the Global Token Tab and paste it on  AIP.
...
1. Now, as the connection of the  AIP and Groove is established, you need to map the **parameters (fields) of **Groove to the user response of the  AIP question.
2. You can use the **\+Add Parameters** button to add more fields.
   ...
   4.  AIP to the Infobip’s **Name **field in the leads. Similarly, for integration to work correctly, you must map all other questions/ components of your Bot to Infobip fields.
...
Once you have established a connection between ** AIP** and **Groove **and complete the mapping, you are ready to go for your first test lead. You can test your integration setup by creating a dummy lead on the bot. This lead should appear in your  AIP dashboard and in the Groove you have integrated.
