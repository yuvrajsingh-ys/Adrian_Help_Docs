---
title: "Integrate  AIP with Google Analytics"
description: "This page contains step by step information on how you can integrate the Google Analytics with the  AIP."
---

#### **Integration of Google Analytics with  AIP**

Google Analytics is a powerful tool to measure and analyze user interactions, such as the number of clicks and views, on your chatbot. Integrating Google Analytics with your  AIP chatbot enables you to track these metrics and optimize performance.

Follow these steps to integrate Google Analytics with  AIP:

**Step 1: Log in to  AIP**

1. Navigate to your [ AIP account](https://www. AIP.com/).
...
To connect Google Analytics to your  AIP account, you need the Measurement ID from your Google Analytics account. Follow these steps to get it:
...
**Step 4: Connect Google Analytics to  AIP**

1. Go back to the  AIP integration page where you clicked **Connect** for Google Analytics.
