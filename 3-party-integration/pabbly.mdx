...
3. \
   Upon clicking “**Create**”, automatic redirection should occur to the workflow as shown below. For creation of trigger from  AIP, search “** AIP**” in the “**Search App**”.
4. \
   After searching and selecting  AIP, select the same type of “**Trigger Event**” you want from the dropdown menu as in  AIP. These can include:
   - **New Lead**: Trigger which occurs whenever a new contact is created in  AIP.
   - **New Incoming Messages**: Occurs when a new message is incoming in the selected chatflow being integrated.
   - **New WhatsApp Order Created**: When a new order is placed.
5. \
   Upon selection, the box will expand as seen below, including in itself several more details. Copy the “**Webhook URL**” and paste it in the “**Pabbly Webhook URL**” in  AIP Dashboard.
6. \
   Paste the copied Webhook URL in the “**Pabbly Webhook URL**” on  AIP, and then click “**Verify & Add Webhook URL**”.
...
4. \
   Search for “** AIP**” in the “**Search App**” area, and select the same.
...
8. \
   Post successful save, information will be need to be entered or mapped that will be sent to  AIP. Edit the same in the given columns.
9. \
