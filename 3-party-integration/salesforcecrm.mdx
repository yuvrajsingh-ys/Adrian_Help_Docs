---
title: "Integrate  AIP with Salesforce CRM"
...
1. Login to your  AIP account. Now, select and click the Bot you want to
...
1. Enter the Salesforce Domain, Client ID and Client Secret and click the ‘Connect’ button to complete integration of  AIP with Salesforce.
...
1. Now, as the connection of the  AIP and Salesforce CRM is established, you need to map **parameters(fields) of Salesforce CRM** to the user response to the  AIP question.
...
As a result, this mapping will enable integration to send the user's response from  AIP to the Salesforce CRM’s **Name **field in the leads. Similarly, in order for integration to work properly, you will require to map all other questions/ components of your Bot to Salesforce CRM fields.
