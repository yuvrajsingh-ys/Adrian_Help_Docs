---
title: "Integrate  AIP with Google Drive"
description: "This page contains all the step by step information of how you can integrate the Google Drive with  AIP."
---

### **Introduction**

Integrating Google Drive with  AIP allows you to utilize external resources for training your AI chatbot.

### **Step-by-Step Integration Process**

#### **1. Login to  AIP**

- Navigate to home page  to log in to your  AIP account.
...
- Review the permissions requested by  AIP.
...
- Contact  AIP support if you encounter any issues.
