---
title: "Integrate  AIP with Razorpay"
description: "This page contains al the necessary information on how you can interate the Razorpay with Botepenguin"
---

### **Prerequisites**

To successfully integrate Razorpay with  AIP, you will need:

- A ** AIP** account.
- A **Razorpay** account.
- A **WhatsApp bot**

This integration enables your WhatsApp bot created on  AIP to collect payments via Razorpay.

#### **Step 1: Login to  AIP and Select WhatsApp Bot**

1. Go to [ AIP](https://www. AIP.com/) and log into your account.
...
To connect Razorpay with  AIP, you need the **Client ID** and **Client Secret** from your Razorpay account.
...
#### **Step 4: Connect Razorpay to  AIP**
...
4. Go back to  AIP and copy the **Webhook URL** from the integration settings.
...
1. Navigate back to your  AIP bot editor.
...
Your  AIP WhatsApp bot is now successfully integrated with Razorpay. You can collect payments seamlessly and track payment events through the configured webhooks. This integration ensures a smooth payment experience for your users directly through WhatsApp.   