...
To use the  AIP APIs, You need to insure that you have following details with you.

A. **UUID** - You can get the UUID from the local web session storage as show in the image below:

![251 Website Contacts Meta Data  AIP Resource C 1 Pn](/images/api-references/website-contact-metadata/251.website_contacts__meta_data__AIP_resource_c-1.png)
...
https://page. AIP.com/BotId/CustomerId
...
<script id=" AIP-messenger-widget" src="https://cdn. AIP.com/ AIP.js" defer>BotId,CustomerId</script>
...
`PUT` `https://api.v7. AIP.com/inbox/direct/lead`
...
`GET` `https://api.v7. AIP.com/inbox/direct/chats`
    ...
    "data": [
        {
            ...
            "lastMessage": {
                ...
                "by": "bot",
                "text": "Welcome to  AIP. I am here to help you."
            },
